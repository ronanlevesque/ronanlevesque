...
var app = angular.module('moovieApp', [
  'firebase',
  'ui.directives',
  'ui.filters'
]);
...
app.directive('login', function() {
  return {
    template:
      '<a href="" class="open-popup" ng-click="openPopup($event)">+</a><a href="" ng-click="logMeOut($event)">-</a>'
  };
});
...
app.controller('MyController', [
  ...
  function MyController($scope, angularFireCollection) {
    $scope.items = angularFireCollection(
      new Firebase('https://moovies.firebaseio.com/')
    );
    $scope.loginOn = false;
