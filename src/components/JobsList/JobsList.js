  ...
  <ul className="m-0 p-0 lis-none">
    {data.map(item => (
      <ListItem key={item.node.company}>
        <span className="d-flex jc-between ai-center fluid:pv-12-16 fluid:ph-8-12">
          <p className="m-0 fxg-1 pr-4 fluid:fsz-14-18 sm:d-flex sm:ai-center">
            <span className="d-block color-zircon fluid:w-180-260">
              {item.node.company}
            </span>
