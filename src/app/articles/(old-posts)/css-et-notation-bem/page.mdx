...
<div className="info">
  Cet article a été fortement influencé par l’article de Harry Roberts intitulé
  [MindBEMding – getting your head ’round BEM
  syntax](http://csswizardry.com/2013/01/mindbemding-getting-your-head-round-bem-syntax/),
  si vous êtes un peu anglophone je conseille vivement sa lecture.
</div>
