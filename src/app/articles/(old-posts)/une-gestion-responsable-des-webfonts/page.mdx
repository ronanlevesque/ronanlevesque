...
import Image1 from '@/images/webfonts-invision.png';

export const metadata = {
  title: 'Une gestion responsable des webfonts',
  description:
    'Une solution mise en place pour éviter l’apparition d’un FOIT avec les webfonts.',
...
<Figure caption="Exemple de FOIT : sur ce site, il m’a fallu une dizaine de secondes pour pouvoir accéder au contenu – malgré ma connexion en WiFi.">
  <Image src={Image1} alt="Exemple de site avec FOIT" />
</Figure>
