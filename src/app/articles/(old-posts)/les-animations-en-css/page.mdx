...
export const metadata = {
  ...
  description:
    'Explication, tutoriel à l’appui, des principes de base des animations en CSS3.',
...
<div className="info">
  Les `@keyframes` ne sont pour l’instant supportées que par certains
  navigateurs : Chrome (et Android), Firefox 5.0+, Opera 12+, Safari 4.0+ et IE
  10+ ([source](https://developer.mozilla.org/fr/docs/CSS/@keyframes) ). Pour
  profiter de ce tutoriel, assurez-vous d’utiliser un de ces navigateurs.
</div>
