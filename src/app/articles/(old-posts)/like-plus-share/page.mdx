...
import Image1 from '@/images/boutons-sociaux.jpg';
...
export const metadata = {
  ...
  description:
    'Le poids et l’impact des boutons de partage sociaux sur un site.',
...
<Figure caption="Un aperçu désormais incontournable…">
  <Image src={Image1} alt="Boutons sociaux" />
</Figure>
