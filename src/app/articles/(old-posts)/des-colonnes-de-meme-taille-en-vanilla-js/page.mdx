...
export const metadata = {
  ...
  description:
    'Cet article décrit comment facilement mettre en place un système de colonnes de hauteur égale en Vanilla JS, tout en prenant en compte le responsive design.',
...
<div className="info">
  ...
  [évolué](http://caniuse.com/#search=flexbox), plus besoin de recourir à du JS
  pour ça.
</div>
