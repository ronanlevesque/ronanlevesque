...
export const metadata = {
  ...
  description:
    'Cet article décrit la façon dont j’ai configuré Gulp pour optimiser au maximum mon workflow au quotidien. Il inclut compilation, compression et concaténation des fichiers.',
...
<div className="info">
  Mise à jour (14/03/2014) : j’ai créé une
  [boilerplate](https://github.com/eskiiss/FOX-Boilerplate-2) pour Gulp, avec
  une configuration bien plus poussée que celle décrite ci-dessous. Je vous
  invite à aller consulter son
  [gulpfile.js](https://github.com/eskiiss/FOX-Boilerplate-2/blob/master/gulpfile.js)
  pour plus d’infos.
</div>
