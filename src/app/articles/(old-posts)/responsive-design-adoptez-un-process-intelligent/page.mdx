...
import Image1 from '@/images/responsive-iceberg.jpg';
...
export const metadata = {
  ...
  description:
    'Cet article s’attarde sur les problèmes que certains processes classiques en webdesign peuvent poser en responsive design.',
...
<div className="info">
  Les processes décrits ci-dessous interviennent entre la définition des besoins
  client et de la stratégie (contenu, architecture etc.) et les phases de
  test/déploiement (tests cross-browsers, UAT, etc.).
</div>
...
<Figure caption="Responsive Iceberg, &copy; Brad Frost">
  <Image src={Image1} alt="Responsive Iceberg" />
</Figure>
