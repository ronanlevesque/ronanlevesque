...
import Image1 from '@/images/advanced-calc-800-opt.png';
...
export const metadata = {
  ...
  description:
    'This article shows how a few lines of JavaScript can help build a small, yet solid CSS framework to handle fluid UIs.',
...
<ArticleOverflowContent className="grid sm:grid-cols-2">
  <figure>
...
<Figure caption="Illustration &copy; Smashing Magazine">
  <Image alt="Fluid CSS calculation" src={Image1} />
</Figure>
