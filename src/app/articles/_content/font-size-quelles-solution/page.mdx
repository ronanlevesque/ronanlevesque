...
<div className="info">
  Mise à jour (29/08/2015) : je suis finalement revenu à du 62.5% + `rem` pour
  la gestion de mes tailles de police; plus simple pour les calculs et le
  support est maintenant [très bon](http://caniuse.com/#search=rem).
</div>
