  ...
  <div>
    <figure>
      <video
        ...
        controls
        muted
        src="https://res.cloudinary.com/dd9noepmq/video/upload/v1589118448/videos/responsive-resize_vtfzl3.mp4"
        type="video/mp4"
      />
  ...
  <div>
    <figure>
      <video
        ...
        controls
        muted
        src="https://res.cloudinary.com/dd9noepmq/video/upload/v1589118339/videos/fluid-resize_a3kcpv.mp4"
        type="video/mp4"
      />
...
<ArticleOverflowContent>
  <figure>
    <video
      ...
      controls
      muted
      src="https://res.cloudinary.com/dd9noepmq/video/upload/v1589118448/videos/fluid-resize-no-breakpoints_fvhjxj.mp4"
      type="video/mp4"
    />
...
I went with shortcut names for my classes here, but it’s really only a matter of personal preference. I also like to use the same prefix naming convention as Tailwind, like so: `.prefix:color-red`. In the end, our class name should look like this:
